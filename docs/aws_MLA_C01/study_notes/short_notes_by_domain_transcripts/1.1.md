...
## Exam Tips and Traps
### **Keywords**
  - "Unprocessed/centralized/HA/pipeline" → S3 data lake. 
  - "Immediate access" → Standard (not One-Zone/Glacier). 
  - "Real-time insights" → Flink/Kinesis (not Athena). 
  - "Reduce ops/cost" → Glue/Flink managed > EMR/SageMaker custom. 
  - "Near real-time Redshift" → Kinesis streaming ingestion.
### **Traps**
